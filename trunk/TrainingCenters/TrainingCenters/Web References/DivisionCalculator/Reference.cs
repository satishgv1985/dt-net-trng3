...
namespace TrainingCenters.DivisionCalculator {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="DivisionSoap", Namespace="http://tempuri.org/")]
    public partial class Division : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public Division() {
            this.Url = global::TrainingCenters.Properties.Settings.Default.TrainingCenters_DivisionCalculator_Division;
        ...
        /// <remarks/>
        public void divideAsync(decimal a, decimal b) {
            this.divideAsync(a, b, null);
        }
        
        /// <remarks/>
        public void divideAsync(decimal a, decimal b, object userState) {
