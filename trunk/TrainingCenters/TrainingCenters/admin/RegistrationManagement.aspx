...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    ...
    <div>
   <%--  <asp:GridView ID="gvRegistration" runat="server" AutoGenerateColumns="False" DataKeyNames="InstituteID"
