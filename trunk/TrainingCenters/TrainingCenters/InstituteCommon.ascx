...
<br />
<asp:HyperLink ID="hlYourProfile" runat="server" NavigateUrl="~/InstituteProfile.aspx">Your Profile</asp:HyperLink>

<br />
<asp:HyperLink ID="hlEnquiry" runat="server" NavigateUrl="~/InstituteSendEnquiry.aspx" >Send Enquiry</asp:HyperLink>