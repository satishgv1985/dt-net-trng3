...
namespace TrainingCenters.DataSet1TableAdapters {
    ...
    public partial class StateTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [State] WHERE (([StateID] = @Original_StateID))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [State] ([StateName]) VALUES (@StateName)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [State] SET [StateName] = @StateName WHERE (([StateID] = @Original_StateID" +
                "))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["TCdbConnectionString"].ConnectionString;
        }
        ...
        public virtual int Fill(DataSet1.StateDataTable dataTable) {
        ...
        public virtual DataSet1.StateDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet1.StateDataTable dataTable = new DataSet1.StateDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet1.StateDataTable dataTable) {
