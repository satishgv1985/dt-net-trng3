<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InstituteUserControl.ascx.cs" Inherits="TrainingCenters.InstituteUserControl" %>
<style type="text/css">
    .style1
    {
        width: 100%;
...
<table class="style1">
    ...
    <tr>
        <td align="right">
                    <asp:Label ID="lblInstituteAddress" runat="server" 
